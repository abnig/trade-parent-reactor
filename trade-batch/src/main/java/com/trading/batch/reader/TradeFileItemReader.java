...
public class TradeFileItemReader extends FlatFileItemReader<TradeRecord> implements StepExecutionListener {

	private static final Logger logger = LoggerFactory.getLogger(TradeFileItemReader.class);

	public TradeFileItemReader(LineMapper<TradeRecord> lineMapper) {
		super(lineMapper);
	}
